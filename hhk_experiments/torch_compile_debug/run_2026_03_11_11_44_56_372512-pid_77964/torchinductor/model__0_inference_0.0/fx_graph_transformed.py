class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f16[1, 8, 32, 128]", arg1_1: "f16[1, 8, 32, 128]", arg2_1: "f16[1, 32, 1, 128]"):
        ...
        view_2: "f32[32, 1, 128]" = torch.ops.aten.reshape.default(expand_2, [32, 1, 128]);  expand_2 = None
        ...
        view: "f32[1, 32, 32, 128]" = torch.ops.aten.reshape.default(clone, [1, 32, 32, 128]);  clone = None
        ...
        view_3: "f32[32, 128, 32]" = torch.ops.aten.reshape.default(expand_3, [32, 128, 32]);  expand_3 = None
        bmm: "f32[32, 1, 32]" = torch.ops.aten.bmm.default(view_2, view_3);  view_2 = view_3 = None
        view_4: "f32[1, 32, 1, 32]" = torch.ops.aten.reshape.default(bmm, [1, 32, 1, 32]);  bmm = None
        ...
        eq: "b8[1, 32, 1, 32]" = torch.ops.aten.eq.Scalar(add, -inf)
        ...
        sub_1: "f32[1, 32, 1, 32]" = torch.ops.aten.sub.Tensor(add, amax);  add = amax = None
        ...
        view_5: "f32[32, 1, 32]" = torch.ops.aten.reshape.default(expand_4, [32, 1, 32]);  expand_4 = None
        ...
        view_1: "f32[1, 32, 32, 128]" = torch.ops.aten.reshape.default(clone_1, [1, 32, 32, 128]);  clone_1 = None
        expand_5: "f32[1, 32, 32, 128]" = torch.ops.aten.expand.default(view_1, [1, 32, 32, 128]);  view_1 = None
        view_6: "f32[32, 32, 128]" = torch.ops.aten.reshape.default(expand_5, [32, 32, 128]);  expand_5 = None
        bmm_1: "f32[32, 1, 128]" = torch.ops.aten.bmm.default(view_5, view_6);  view_5 = view_6 = None
        view_7: "f32[1, 32, 1, 128]" = torch.ops.aten.reshape.default(bmm_1, [1, 32, 1, 128]);  bmm_1 = None
